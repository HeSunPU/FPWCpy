...
class Optical_Model:
	def __init__(self, wavelength, DM1gain, DM2gain, wfe=False, error_maps=[]):
		...
		self.Nlyot = self.Nsp
		self.apertureMask = fits.getdata('./masks/splc_aperture.fits', ext=0)
		self.SPshape = fits.getdata('./masks/splc_apodizer.fits', ext=0)
		self.FPmask = fits.getdata('./masks/splc_FPM_990by990.fits', ext=0)
		self.LyotStop = fits.getdata('./masks/splc_lyot_1000by1000.fits', ext=0)
